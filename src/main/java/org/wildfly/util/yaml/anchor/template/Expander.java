    ...
    public String expandInput() throws Exception {
        ...
        for (Object keyObj : map.keySet()) {
            if (keyObj instanceof String) {
                ...
                System.out.println("[WARN] Non-String key: " + keyObj);
                System.out.println("Note that some keys need quoting or they will be converted to a boolean or a number.");
                System.out.println("This key will be skipped, so please inspect your output, as something has been skipped.");
            }
        }
